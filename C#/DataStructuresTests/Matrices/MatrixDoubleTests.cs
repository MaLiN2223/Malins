namespace DataStructuresTests.Matrices
{
    ...
    {
        private readonly MatrixFactory DoubleFactory = new MatrixFactory();
        ...
        public void ArrayType()
        {
            ...
            var m = (Matrix) this.DoubleFactory.Create(data);
        ...
        public void ColumnRowTest()
        {
            ...
            var matrix = this.DoubleFactory.Create(data);
            ...
            matrix = this.DoubleFactory.Create(data);
            Assert.AreEqual(4, matrix.ColumnCount);
        ...
        public void WrongAddition()
        {
            ...
            var m = this.DoubleFactory.Create(data);
            var m2 = this.DoubleFactory.Create(data2);
            var k = m + m2;
        }
        ...
        public void Determinant()
        {
            ...
            var m3 = this.DoubleFactory.Create(data3);
            ...
            var m4 = this.DoubleFactory.Create(data4);
        ...
        public void Decompose()
        {
            ...
            var m = this.DoubleFactory.Create(data);
            var L = this.DoubleFactory.Create(dataL);
            var U = this.DoubleFactory.Create(dataU);
        ...
        public void Clonning()
        {
            ...
            var m1 = this.DoubleFactory.Create(data);
